...
var store_switcher_1 = __importDefault(require("@/components/store-switcher"));
var main_nav_1 = require("@/components/main-nav");
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                ...
                return [4 /*yield*/, prismadb_1.default.store.findMany({
                        where: {
                            userId: userId,
                        }
                    })];
      ...
      <div className="flex h-16 items-center px-4">
        <store_switcher_1.default items={stores}/>
        <main_nav_1.MainNav className="mx-6"/>
