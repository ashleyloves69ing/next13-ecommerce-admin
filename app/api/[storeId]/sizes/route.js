...
function POST(req, _a) {
    ...
    return __awaiter(this, void 0, void 0, function () {
        var userId, body, name_1, value, storeByUserId, size, error_1;
        return __generator(this, function (_b) {
            switch (_b.label) {
                ...
                case 2:
                    ...
                    return [4 /*yield*/, prismadb_1.default.size.create({
                            data: {
                                name: name_1,
                                value: value,
                ...
                case 4:
                    error_1 = _b.sent();
                    console.log('[SIZES_POST]', error_1);
    ...
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_b) {
            switch (_b.label) {
                ...
                case 1:
                    sizes = _b.sent();
                    return [2 /*return*/, server_1.NextResponse.json(sizes)];
                case 2:
                    error_2 = _b.sent();
                    console.log('[SIZES_GET]', error_2);
                    return [2 /*return*/, new server_1.NextResponse("Internal error", { status: 500 })];
