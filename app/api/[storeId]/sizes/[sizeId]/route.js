        ...
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0:
                    ...
                    return [4 /*yield*/, prismadb_1.default.size.findUnique({
                            where: {
                                id: params.sizeId
                            }
                        })];
                case 1:
                    size = _b.sent();
                    return [2 /*return*/, server_1.NextResponse.json(size)];
                case 2:
                    error_1 = _b.sent();
                    console.log('[SIZE_GET]', error_1);
...
function DELETE(req, _a) {
    var params = _a.params;
    return __awaiter(this, void 0, void 0, function () {
        var userId, storeByUserId, size, error_2;
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0:
                    _b.trys.push([0, 3, , 4]);
                ...
                case 1:
                    ...
                    return [4 /*yield*/, prismadb_1.default.size.delete({
                            where: {
                                id: params.sizeId
                            }
                        })];
                ...
                case 3:
                    error_2 = _b.sent();
                    console.log('[SIZE_DELETE]', error_2);
                    return [2 /*return*/, new server_1.NextResponse("Internal error", { status: 500 })];
...
function PATCH(req, _a) {
    var params = _a.params;
    return __awaiter(this, void 0, void 0, function () {
        var userId, body, name_1, value, storeByUserId, size, error_3;
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0:
                    _b.trys.push([0, 4, , 5]);
                ...
                case 2:
                    ...
                    return [4 /*yield*/, prismadb_1.default.size.update({
                            where: {
                                id: params.sizeId
                            },
                            data: {
                ...
                case 4:
                    error_3 = _b.sent();
                    console.log('[SIZE_PATCH]', error_3);
                    return [2 /*return*/, new server_1.NextResponse("Internal error", { status: 500 })];
