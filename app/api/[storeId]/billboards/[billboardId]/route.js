        ...
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0:
                    ...
                    return [4 /*yield*/, prismadb_1.default.billboard.findUnique({
                            where: {
                ...
                case 2:
                    error_1 = _b.sent();
                    console.log('[BILLBOARD_GET]', error_1);
...
function DELETE(req, _a) {
    var params = _a.params;
    return __awaiter(this, void 0, void 0, function () {
        var userId, storeByUserId, billboard, error_2;
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0:
                    _b.trys.push([0, 3, , 4]);
                ...
                case 1:
                    ...
                    return [4 /*yield*/, prismadb_1.default.billboard.delete({
                            where: {
                                id: params.billboardId,
                            }
                        })];
                ...
                case 3:
                    error_2 = _b.sent();
                    console.log('[BILLBOARD_DELETE]', error_2);
                    return [2 /*return*/, new server_1.NextResponse("Internal error", { status: 500 })];
...
function PATCH(req, _a) {
    var params = _a.params;
    return __awaiter(this, void 0, void 0, function () {
        var userId, body, label, imageUrl, storeByUserId, billboard, error_3;
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0:
                    _b.trys.push([0, 4, , 5]);
                ...
                case 2:
                    ...
                    return [4 /*yield*/, prismadb_1.default.billboard.update({
                            where: {
                                id: params.billboardId,
                            },
                            data: {
                ...
                case 4:
                    error_3 = _b.sent();
                    console.log('[BILLBOARD_PATCH]', error_3);
                    return [2 /*return*/, new server_1.NextResponse("Internal error", { status: 500 })];
