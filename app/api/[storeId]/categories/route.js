...
function POST(req, _a) {
    ...
    return __awaiter(this, void 0, void 0, function () {
        var userId, body, name_1, billboardId, storeByUserId, category, error_1;
        return __generator(this, function (_b) {
            switch (_b.label) {
                ...
                case 2:
                    ...
                    return [4 /*yield*/, prismadb_1.default.category.create({
                            data: {
                                name: name_1,
                ...
                case 4:
                    error_1 = _b.sent();
                    console.log('[CATEGORIES_POST]', error_1);
    ...
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_b) {
            switch (_b.label) {
                ...
                case 2:
                    error_2 = _b.sent();
                    console.log('[CATEGORIES_GET]', error_2);
                    return [2 /*return*/, new server_1.NextResponse("Internal error", { status: 500 })];
