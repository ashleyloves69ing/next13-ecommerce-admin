        ...
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0:
                    ...
                    return [4 /*yield*/, prismadb_1.default.color.findUnique({
                            where: {
                                id: params.colorId
                            }
                        })];
...
function DELETE(req, _a) {
    var params = _a.params;
    return __awaiter(this, void 0, void 0, function () {
        var userId, storeByUserId, color, error_2;
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0:
                    _b.trys.push([0, 3, , 4]);
                ...
                case 1:
                    ...
                    return [4 /*yield*/, prismadb_1.default.color.delete({
                            where: {
                                id: params.colorId
                            }
                        })];
                ...
                case 3:
                    error_2 = _b.sent();
                    console.log('[COLOR_DELETE]', error_2);
                    return [2 /*return*/, new server_1.NextResponse("Internal error", { status: 500 })];
...
function PATCH(req, _a) {
    var params = _a.params;
    return __awaiter(this, void 0, void 0, function () {
        var userId, body, name_1, value, storeByUserId, color, error_3;
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0:
                    _b.trys.push([0, 4, , 5]);
                ...
                case 2:
                    ...
                    return [4 /*yield*/, prismadb_1.default.color.update({
                            where: {
                                id: params.colorId
                            },
                            data: {
                ...
                case 4:
                    error_3 = _b.sent();
                    console.log('[COLOR_PATCH]', error_3);
                    return [2 /*return*/, new server_1.NextResponse("Internal error", { status: 500 })];
