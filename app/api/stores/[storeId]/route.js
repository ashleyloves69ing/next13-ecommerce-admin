...
exports.DELETE = exports.PATCH = void 0;
...
function PATCH(req, _a) {
    ...
    return __awaiter(this, void 0, void 0, function () {
        var userId, body, name_1, store, error_1;
        return __generator(this, function (_b) {
            switch (_b.label) {
                ...
                case 1:
                    ...
                    return [4 /*yield*/, prismadb_1.default.store.updateMany({
                            where: {
                                id: params.storeId,
                                userId: userId,
                            },
                ...
                case 2:
                    store = _b.sent();
                    return [2 /*return*/, server_1.NextResponse.json(store)];
                case 3:
                    error_1 = _b.sent();
                    console.log('[STORE_PATCH]', error_1);
        ...
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0:
                    ...
                    return [4 /*yield*/, prismadb_1.default.store.deleteMany({
                            where: {
                                id: params.storeId,
                                userId: userId
                            }
                ...
                case 2:
                    error_2 = _b.sent();
                    console.log('[STORE_DELETE]', error_2);
                    return [2 /*return*/, new server_1.NextResponse("Internal error", { status: 500 })];
