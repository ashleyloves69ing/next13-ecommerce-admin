...
;
var BillboardForm = function (_a) {
    var initialData = _a.initialData;
    var params = (0, navigation_1.useParams)();
    var router = (0, navigation_1.useRouter)();
    var _b = (0, react_1.useState)(false), open = _b[0], setOpen = _b[1];
    var _c = (0, react_1.useState)(false), loading = _c[0], setLoading = _c[1];
    var title = initialData ? 'Edit billboard' : 'Create billboard';
    var description = initialData ? 'Edit a billboard.' : 'Add a new billboard';
    var toastMessage = initialData ? 'Billboard updated.' : 'Billboard created.';
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    return [4 /*yield*/, axios_1.default.patch("/api/".concat(params.storeId, "/billboards/").concat(params.billboardId), data)];
                case 1:
                    _a.sent();
                    return [3 /*break*/, 4];
                case 2: return [4 /*yield*/, axios_1.default.post("/api/".concat(params.storeId, "/billboards"), data)];
                case 3:
                    _a.sent();
                    _a.label = 4;
                case 4:
                    router.refresh();
                    router.push("/".concat(params.storeId, "/billboards"));
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    setLoading(true);
                    return [4 /*yield*/, axios_1.default.delete("/api/".concat(params.storeId, "/billboards/").concat(params.billboardId))];
                case 1:
                    _a.sent();
                    router.refresh();
                    router.push("/".concat(params.storeId, "/billboards"));
     ...
     <div className="flex items-center justify-between">
      ...
      <form_1.Form {...form}>
        <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-8 w-full">
          <form_1.FormField control={form.control} name="imageUrl" render={function (_a) {
            var field = _a.field;
            return (<form_1.FormItem>
                  <form_1.FormLabel>Background image</form_1.FormLabel>
                  <form_1.FormControl>
                    <image_upload_1.default value={field.value ? [field.value] : []} disabled={loading} onChange={function (url) { return field.onChange(url); }} onRemove={function () { return field.onChange(''); }}/>
                  </form_1.FormControl>
                  <form_1.FormMessage />
                </form_1.FormItem>);
        }}/>
          <div className="md:grid md:grid-cols-3 gap-8">
            <form_1.FormField control={form.control} name="label" render={function (_a) {
            var field = _a.field;
            return (<form_1.FormItem>
                  <form_1.FormLabel>Label</form_1.FormLabel>
                  <form_1.FormControl>
                    <input_1.Input disabled={loading} placeholder="Billboard label" {...field}/>
                  </form_1.FormControl>
                  <form_1.FormMessage />
                </form_1.FormItem>);
        }}/>
...
exports.BillboardForm = BillboardForm;
