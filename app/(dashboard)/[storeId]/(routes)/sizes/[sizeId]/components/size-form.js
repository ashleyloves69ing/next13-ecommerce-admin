...
;
var SizeForm = function (_a) {
    var initialData = _a.initialData;
    var params = (0, navigation_1.useParams)();
    var router = (0, navigation_1.useRouter)();
    var _b = (0, react_1.useState)(false), open = _b[0], setOpen = _b[1];
    var _c = (0, react_1.useState)(false), loading = _c[0], setLoading = _c[1];
    var title = initialData ? 'Edit size' : 'Create size';
    var description = initialData ? 'Edit a size.' : 'Add a new size';
    var toastMessage = initialData ? 'Size updated.' : 'Size created.';
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    return [4 /*yield*/, axios_1.default.patch("/api/".concat(params.storeId, "/sizes/").concat(params.sizeId), data)];
                case 1:
                    _a.sent();
                    return [3 /*break*/, 4];
                case 2: return [4 /*yield*/, axios_1.default.post("/api/".concat(params.storeId, "/sizes"), data)];
                case 3:
                    _a.sent();
                    _a.label = 4;
                case 4:
                    router.refresh();
                    router.push("/".concat(params.storeId, "/sizes"));
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    setLoading(true);
                    return [4 /*yield*/, axios_1.default.delete("/api/".concat(params.storeId, "/sizes/").concat(params.sizeId))];
                case 1:
                    _a.sent();
                    router.refresh();
                    router.push("/".concat(params.storeId, "/sizes"));
                    react_hot_toast_1.toast.success('Size deleted.');
                    return [3 /*break*/, 4];
                case 2:
                    error_2 = _a.sent();
                    react_hot_toast_1.toast.error('Make sure you removed all products using this size first.');
                    return [3 /*break*/, 4];
                case 3:
                    setLoading(false);
                    setOpen(false);
        ...
        <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-8 w-full">
          <div className="md:grid md:grid-cols-3 gap-8">
            ...
            return (<form_1.FormItem>
                  ...
                  <form_1.FormControl>
                    <input_1.Input disabled={loading} placeholder="Size name" {...field}/>
                  </form_1.FormControl>
                  <form_1.FormMessage />
                </form_1.FormItem>);
        }}/>
            ...
            return (<form_1.FormItem>
                  ...
                  <form_1.FormControl>
                    <input_1.Input disabled={loading} placeholder="Size value" {...field}/>
                  </form_1.FormControl>
                  <form_1.FormMessage />
                </form_1.FormItem>);
        }}/>
