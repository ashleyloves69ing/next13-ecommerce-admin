...
var CategoryForm = function (_a) {
    var initialData = _a.initialData, billboards = _a.billboards;
    var params = (0, navigation_1.useParams)();
    var router = (0, navigation_1.useRouter)();
    var _b = (0, react_1.useState)(false), open = _b[0], setOpen = _b[1];
    var _c = (0, react_1.useState)(false), loading = _c[0], setLoading = _c[1];
    var title = initialData ? 'Edit category' : 'Create category';
    var description = initialData ? 'Edit a category.' : 'Add a new category';
    var toastMessage = initialData ? 'Category updated.' : 'Category created.';
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    return [4 /*yield*/, axios_1.default.patch("/api/".concat(params.storeId, "/categories/").concat(params.categoryId), data)];
                case 1:
                    _a.sent();
                    return [3 /*break*/, 4];
                case 2: return [4 /*yield*/, axios_1.default.post("/api/".concat(params.storeId, "/categories"), data)];
                case 3:
                    _a.sent();
                    _a.label = 4;
                case 4:
                    router.refresh();
                    router.push("/".concat(params.storeId, "/categories"));
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    setLoading(true);
                    return [4 /*yield*/, axios_1.default.delete("/api/".concat(params.storeId, "/categories/").concat(params.categoryId))];
                case 1:
                    _a.sent();
                    router.refresh();
                    router.push("/".concat(params.storeId, "/categories"));
                    react_hot_toast_1.toast.success('Category deleted.');
                    return [3 /*break*/, 4];
                case 2:
                    error_2 = _a.sent();
                    react_hot_toast_1.toast.error('Make sure you removed all products using this category first.');
                    return [3 /*break*/, 4];
                case 3:
                    setLoading(false);
                    setOpen(false);
        ...
        <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-8 w-full">
          <div className="md:grid md:grid-cols-3 gap-8">
            ...
            return (<form_1.FormItem>
                  ...
                  <form_1.FormControl>
                    <input_1.Input disabled={loading} placeholder="Category name" {...field}/>
                  </form_1.FormControl>
                  <form_1.FormMessage />
                </form_1.FormItem>);
        }}/>
            <form_1.FormField control={form.control} name="billboardId" render={function (_a) {
            var field = _a.field;
            return (<form_1.FormItem>
                  <form_1.FormLabel>Billboard</form_1.FormLabel>
                  <select_1.Select disabled={loading} onValueChange={field.onChange} value={field.value} defaultValue={field.value}>
                    <form_1.FormControl>
                      <select_1.SelectTrigger>
                        <select_1.SelectValue defaultValue={field.value} placeholder="Select a billboard"/>
                      </select_1.SelectTrigger>
                    </form_1.FormControl>
                    <select_1.SelectContent>
                      {billboards.map(function (billboard) { return (<select_1.SelectItem key={billboard.id} value={billboard.id}>{billboard.label}</select_1.SelectItem>); })}
                    </select_1.SelectContent>
                  </select_1.Select>
                  <form_1.FormMessage />
                </form_1.FormItem>);
