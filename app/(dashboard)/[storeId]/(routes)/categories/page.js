...
var CategoriesPage = function (_a) {
    var params = _a.params;
    return __awaiter(void 0, void 0, void 0, function () {
        var categories, formattedCategories;
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0: return [4 /*yield*/, prismadb_1.default.category.findMany({
                        where: {
                ...
                case 1:
                    categories = _b.sent();
                    formattedCategories = categories.map(function (item) { return ({
                        id: item.id,
                        name: item.name,
      ...
      <div className="flex-1 space-y-4 p-8 pt-6">
        <client_1.CategoriesClient data={formattedCategories}/>
      </div>
    </div>)];
            }
        });
