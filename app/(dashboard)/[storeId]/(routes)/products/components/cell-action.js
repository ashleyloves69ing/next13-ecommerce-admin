...
var CellAction = function (_a) {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    setLoading(true);
                    return [4 /*yield*/, axios_1.default.delete("/api/".concat(params.storeId, "/products/").concat(data.id))];
                case 1:
                    _a.sent();
    ...
    var onCopy = function (id) {
        ...
        react_hot_toast_1.toast.success('Product ID copied to clipboard.');
    };
    return (<>
      ...
      <dropdown_menu_1.DropdownMenu>
        ...
        <dropdown_menu_1.DropdownMenuContent align="end">
          ...
          <dropdown_menu_1.DropdownMenuItem onClick={function () { return router.push("/".concat(params.storeId, "/products/").concat(data.id)); }}>
