...
var ProductsPage = function (_a) {
    ...
    return __awaiter(void 0, void 0, void 0, function () {
        var products, formattedProducts;
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0: return [4 /*yield*/, prismadb_1.default.product.findMany({
                        where: {
                ...
                case 1:
                    products = _b.sent();
                    formattedProducts = products.map(function (item) { return ({
                        id: item.id,
                        name: item.name,
                        isFeatured: item.isFeatured,
                        isArchived: item.isArchived,
                        price: utils_1.formatter.format(item.price.toNumber()),
      ...
      <div className="flex-1 space-y-4 p-8 pt-6">
        <client_1.ProductsClient data={formattedProducts}/>
      </div>
    </div>)];
            }
        });
